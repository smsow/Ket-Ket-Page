...
class UpdatePartnerForm1Request extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => 'sometimes|required|email|unique:partners_form1,email,' . $this->route('partners_form1'),
            ...
            'position_entreprise' => 'sometimes|required|string|max:255',
    ...
    {
        return [
            'prenom.sometimes' => 'Le prénom est requis dans certaines situations.',
            'prenom.required' => 'Le prénom est obligatoire.',
            'prenom.string' => 'Le prénom doit être une chaîne de caractères.',
            'prenom.max' => 'Le prénom ne doit pas dépasser 255 caractères.',

            'nom.sometimes' => 'Le nom est requis dans certaines situations.',
            'nom.required' => 'Le nom est obligatoire.',
            'nom.string' => 'Le nom doit être une chaîne de caractères.',
            'nom.max' => 'Le nom ne doit pas dépasser 255 caractères.',

            'email.sometimes' => 'L\'email est requis dans certaines situations.',
            'email.required' => 'L\'email est obligatoire.',
            'email.email' => 'L\'email doit être une adresse email valide.',
            'email.unique' => 'L\'email existe déjà dans notre base de données.',

            'numero_telephone.sometimes' => 'Le numéro de téléphone est requis dans certaines situations.',
            ...
            'date_disponible.sometimes' => 'La date de disponibilité est requise dans certaines situations.',
            ...
            'nom_entreprise.sometimes' => 'Le nom de l\'entreprise est requis dans certaines situations.',
            ...
            'position_entreprise.sometimes' => 'La position dans l\'entreprise est requise dans certaines situations.',
            ...
            'description_entreprise.sometimes' => 'La description de l\'entreprise est requise dans certaines situations.',
