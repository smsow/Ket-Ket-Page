...
export default function Hero() {
    ...
    return (
      <div className="hero_container relative  h-[82%] w-[100%] overflow-visible max-lg:h-[100%]">
                <div className="hero-content-container relative flex bg-green-400 h-[96.5%] w-[100%] mt-[1.2%] max-lg:flex-col-reverse">
                    <div className="hero-text-container relative w-[52%] h-[100%] bg-blue-400 flex-col overflow-visible max-lg:w-[100%] max-lg:h-[40%] max-lg:mt-12 max-md:h-[60%]">
                        <div className="hero-text relative ml-[12.5%] h-[38%] w-[59%] bg-white max-lg:ml-[0%] max-lg:w-[65%] max-md:w-[100%] max-md:h-[30.5%]">
                        ...
                        <div className="hero-subtitle min-h-[18%] w-[51%] bg-orange-400 ml-[14.5%] mt-[3.25%] max-2xl:ml-[12%] max-2xl:w-[60%] max-lg:ml-[2.5%] max-lg:w-[65%] max-md:w-[95%]">
                            <div className="text-h5 leading-h5 font-arial max-md:text-h6 max-md:leading-h6">
                            {articleWithId1?.subtitle}
                            </div>
                        </div>
                        <div className="email-input bg-cyan-400 h-[15%] w-[64%] ml-[14.25%] mt-[6%] flex-col max-lg:ml-[2.5%] max-lg:w-[70%] max-lg:mt-[3%] max-lg:h-[25%] max-2xl:ml-[12.5%] max-md:w-[95%] max-md:h-[20%]">
                        ...
                        <div className="accolades h-[10%] mt-[5%] w-[85.5%] bg-orange-400 ml-auto flex gap-[1%] max-ml:ml-[12.5%] max-2xl:flex-wrap max-2xl:place-content-start max-2xl:gap-[5%] max-lg:flex-wrap max-lg:ml-[2.5%] max-lg:h-auto max-lg:w-[90%] max-2xl:h-[20%] max-xl:w-[90%]">

                            <div className="award bg-lime-400 w-[280px] h-[70px] flex place-content-start items-center gap-[9.55%] max-[1690px]:gap-[5%] max-2xl:gap[15%] max-lg:mt-[30px]">
                            ...
                            <div className="award bg-lime-400 w-[280px] h-[70px] flex place-content-start items-center gap-[9.5%] max-[1690px]:gap-[5%] max-2xl:gap[15%] max-lg:mt-[30px]">
                            ...
                            <div className="award bg-lime-400 w-[280px] h-[70px] flex place-content-center items-center gap-[9.5%] max-[1690px]:gap-[5%] max-2xl:gap[15%] max-lg:mt-[30px]">
                    ...
                    <div className="hero-image-container  relative w-[48%] h-[93%] bg-red-400 max-lg:w-[100%] max-lg:h-[60%] max-lg:flex max-lg:place-content-center max-md:h-[50%] ">
                    <div className="relative h-[71%] w-[71.8%] mt-[5.75%] ml-[15%] hero-image-shadow  bg-no-repeat bg-cover bg-center max-lg:h-[95%] max-lg:ml-[0%] max-lg:w-[95%] max-lg:mt-[2%]"
                    style={{
                    ...
                    <img className="absolute bottom-0 left-[69.5%] max-2xl:h-[30%] max-2xl:w-[30%] max-2xl:bottom-8 max-lg:hidden" src="./img/red-circle.png" alt="..." />  
                    </div>
                </div>
      </div>
    )
