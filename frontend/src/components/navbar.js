    ...
    return (
        <div className="Navbar  flex items-center max-[1200px]:w-[100%]">
            ...
            max-xl:left-8 max-[1200px]:hidden">
                ...
                <Link to="/recherche" className="relative bg-main-blue border-2 border-[#1D428A] group-hover:fill-[#1D428A] hover:path-[#1D428A] hover:stroke-[#1D428A] hover:bg-white hover:text-[#1D428A] text-xl  text-white w-[41.5%] font-light h-[100%] rounded-full flex justify-center items-center gap-[19px]">
